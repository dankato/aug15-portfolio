particlesJS('particles-js', {'particles':{'number':{'value':80,'density':{'enable':false,'value_area':7812.5616521595}},
'color':{'value':'#ffffff'},
...
'size':{'value':2,'random':true,'anim':{'enable':false,'speed':14.385614385614385,'size_min':0.1,'sync':false}},
'line_linked':{'enable':true,'distance':25,'color':'#ffffff','opacity':0.4,'width':1},
'move':{'enable':true,'speed':1,'direction':'top','random':true,'straight':true,'out_mode':'out',
